...
- "Generate" button (cornflowerblue) to resample 20 points
...
Usage (inside a Colab/Jupyter cell):
    ...
    launch()  # optionally: launch(n=20, color='cornflowerblue')
...
def launch(
    n: int = 20,
    r_default: float = 0.0,
    color: str | None = None,          # e.g., 'cornflowerblue' to match the button
    point_size: int = 60,
    show_grid: bool = True,
) -> None:
    """
